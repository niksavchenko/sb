...
rmDirRecursive(pth($root . "tools/www/assets"));
createDirIfNotExists(pth($root . "tools/www/assets"));

// runtime
createDirIfNotExists(pth($root . "frontend/runtime"));
createDirIfNotExists(pth($root . "backend/runtime"));
createDirIfNotExists(pth($root . "tools/runtime"));
